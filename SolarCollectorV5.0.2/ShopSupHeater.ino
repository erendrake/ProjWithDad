...
{
/*  Serial.println("Supplemental Heater Sketch.");
    char mode;
  ...
  if ((currentShopTemp >= (hvacSetPoint - 2)) && heaterStatus() != true);
  {
    // Send Message to Shop Sup Heater Node to Turn On
      heaterControl.set(true);
