/**
  "SolarHeaterControllerV4-2-7", "RW/CW 1/21/17"
...
// **** Timers ****
unsigned long minimumPumpOnMilliSec = (MINIMUM_PUMP_ON_SECONDS * 1000);
unsigned long tempPollingDelay = TEMP_POLLING_DELAY_SECONDS;
unsigned long minimumFanOnMs = 60000;
unsigned long fanDelayMs = 10000;
...
void presentation()
{
  sendSketchInfo("SolarHeaterControllerV4-2-7", "RW/CW 1/21/17");
