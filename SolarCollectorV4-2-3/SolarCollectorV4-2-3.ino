/**
  "SolarHeaterControllerV4-2-3", "RW/CW 1/15/17"
...
// Thermostat
const int set_Temp_Pot_Pin = A4;                  // Analog Pin for Thermostat Pot
...
void presentation()
{
  ...
  sendSketchInfo("SolarHeaterControllerV4-2-3", "RW/CW 1/15/17");
