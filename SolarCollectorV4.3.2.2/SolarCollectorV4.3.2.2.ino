...
const byte Number_Child_IDs           =   18; // Number of Child ID's
...
const byte Attic_Gable_Louver_ID      =   15; // Attic Gable Louver South End (for summer cooling)
const byte Tank_Heater_ID             =   16; // Storage Tank Heater on/off
