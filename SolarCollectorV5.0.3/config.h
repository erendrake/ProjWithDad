...
// ONE_WIRE_BUS = 22;                             // * Dallas Temp Sensors Pin Defined in Main Sketch
...
float systemDiffOn = 8.0;                      // 8°
float systemDiffOff = 2.0;                     // 2°
float systemOverheat = 140.0;                  // OverTemp Tank Temp >= 140°
...
DeviceAddress Tank_Temp_Addr =        {0x28, 0x80, 0xEA, 0x29, 0x07, 0x00, 0x00, 0x0A};
